    ...
    <div class="p-4 lg:p-6">
        ...
        <div class="flex items-center justify-between mb-4">
            <p class="text-sm text-gray-600">
                Menampilkan <span class="font-semibold text-gray-900">{{ $tasks->firstItem() ?? 0 }}</span>&ndash;<span class="font-semibold text-gray-900">{{ $tasks->lastItem() ?? 0 }}</span> dari <span class="font-semibold text-gray-900">{{ $tasks->total() }}</span> tugas selesai
            </p>
