...
<body class="font-sans antialiased">
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-50">
        ...
        <p class="text-gray-600 mb-8 text-center">
            Kelola tugas kuliahmu dengan metode Eisenhower
        </p>

        <!-- Google Sign In Button -->
        <a href="{{ route('auth.google') }}" class="inline-flex items-center justify-center px-6 py-3 border border-gray-300 rounded-lg bg-white text-gray-700 hover:bg-gray-50 transition-colors duration-200 shadow-sm">
